...
import Entryupperleft from './Entryupperleft';
const Entry = () => {
          ...
          <Uppertop/>
            <div className="upperbottom">
              <div className="slide">
                ...
                <p>Love  is in the <br />Air <br /><br />
                At<br />
               <span>-27<sup>%</sup></span><br />
                <button>visit</button>
                
                </p>

                  <img src="slideone.webp" width = '650px'alt="" />
                </div>
                <div className="slide2">
                  <img src="slidetwo.webp" width='650px' alt="" />
                </div>
              </div>
              ...
              <div className="klein">
                <div className="klein1">
                  <div className="ringer">
                    ...
                    <div className="text">
                      <p>Bransoletka CALVIN <br /> KLEIN, Skóra, Stal </p><br />
                      <p>$399.00</p>
                      <br />
                    </div>
                  </div>
